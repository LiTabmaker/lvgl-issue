...
{
    /* #10308: L463 overflow when indic_w * (cur-min) > INT32_MAX */
...
{
    /* #10308: L449 overflow for start_value pixel position */
    lv_obj_set_size(g_bar, 600, 24);
    lv_bar_set_mode(g_bar, LV_BAR_MODE_RANGE);
    lv_bar_set_range(g_bar, 0, 20000000);
...
{
    /* #10308: L454/L456 overflow during cur_value animation */
    lv_obj_set_size(g_bar, 600, 24);
    lv_bar_set_range(g_bar, 0, 20000000);
    lv_bar_set_value(g_bar, 2000000, LV_ANIM_OFF);
    lv_refr_now(NULL);
...
{
    /* #10308: L439/L441 overflow during start_value animation */
    lv_obj_set_size(g_bar, 600, 24);
    lv_bar_set_mode(g_bar, LV_BAR_MODE_RANGE);
    lv_bar_set_range(g_bar, 0, 20000000);
    lv_bar_set_value(g_bar, 19000000, LV_ANIM_OFF);
